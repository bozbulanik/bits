...
const BitTypeCreate = () => {
  ...
  const addNewBitType = () => {
    ...
    addBitType(bitTypeName, bitTypeIcon, currentProperties)
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="h-12 flex items-center p-2">
        <div className="flex-1 h-full flex items-center drag-bar">
          <p className="ml-1 font-semibold">
            {bitTypeName == '' ? 'Create Bit Type' : bitTypeName + ' Type'}
          </p>
        </div>
        <Button
      ...
      <div className="mt-auto p-2 bg-scry-bg dark:bg-scry-bg-dark border-t border-border dark:border-border-dark flex items-center gap-2">
        ...
        <Button onClick={addNewBitType} className="ml-auto" variant={'default'}>
          <Plus size={16} strokeWidth={1.5} />
          Create Bit Type
        </Button>
      </div>
